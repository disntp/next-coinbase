...
const ButtonWallet = ({authenticate}) => {
  return (
    <div className="flex h-screen items-center justify-center bg-cover">
      ...
      <button onClick={authenticate} className="bg-yellow-300 px-6 py-3 rounded-xl text-lg animate-bounce uppercase hover:bg-white hover:text-black hover:animate-none meta-btn button_wallet">
